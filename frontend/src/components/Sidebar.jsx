 ...
 import { RiCoinsLine, RiHomeFill } from "react-icons/ri";
...
const Sidebar = ({user, closeToggle}) => {
  ...
  return (
    <div className="flex flex-col justify-between bg-white h-full overflow-x-scroll min-w-210 hide-scrollbar">
